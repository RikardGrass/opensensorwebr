...
# Description
This package provides access to the Sensoto-API (https://api.sensoto.io/v1/) to create data sets for crop modelling. 
The OpenSensorWeb-API (api.opensensorweb.de) is now deprecated (11.6.2025) 
...
## Get a listing of available sensors
```{r, eval = TRUE}
...
## Get a dataset to calculate evaportranspiration according to Penman Monteight
